...
const HeaderClient = ({
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 w-full py-3 px-4 md:py-0 z-10 transition-all duration-300 ${
        isScrolled ? "bg-blue-500 shadow-lg" : "bg-transparent"
      }`}
    >
      <div className="flex justify-center">
        <div className="flex justify-between items-center w-full md:p-4 max-w-[425px] md:max-w-[1440px]">
